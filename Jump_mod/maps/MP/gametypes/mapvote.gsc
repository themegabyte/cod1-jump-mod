...
CreateHud()
{
	...
	level.advertise_full_scr_shader.alpha = .09;
...
getMapName(map)
{
	switch(map)
	{
		case "mp_brecourt":
			mapname = "Brecourt";
			level.advertise_full_scr_shader.color = (0, 1, 0);
			break;

		case "mp_carentan":
			mapname = "Carentan";
			level.advertise_full_scr_shader.color = (1, 1, 0);
			break;
		
		case "mp_harbor":
			mapname = "Harbor";
			level.advertise_full_scr_shader.color = (0, 0, 0);
			break;
